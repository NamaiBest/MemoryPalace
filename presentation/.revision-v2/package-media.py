...
import subprocess
B=Path(__file__).resolve().parent; A=B.parent/'revised/assets'; V=B.parent/'revised-v2/assets'
...
for num,kind,video,poster in [(3,'intro',A/'MemoryPalace-36s.mp4',A/'film-poster.png'),(8,'baseline',V/'original-calibration.mp4',B/'previews/08.png'),(9,'persistence',V/'persistence-restored.mp4',B/'persistence-restored.png')]:
